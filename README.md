# genpark-vision-guided-browser-dom-navigation-agent-skill
...
> **GenPark AI Agent Skill** -- Vision-guided browser DOM navigation agent & multi-step workflow executor (Skyvern style)
